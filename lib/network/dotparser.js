...
function isAlphaNumeric(c) {
  var cAsciiCode = c.getCharcodeAt(0);

  if(cAsciiCode < 47){ // #.
    return cAsciiCode === 35 || cAsciiCode === 46;
  }
  if(cAsciiCode < 59) { // 0-9 and :
    return cAsciiCode > 47;
  }
  if(cAsciiCode < 91) { // A-Z
    return cAsciiCode > 64;
  }
  if (cAsciiCode < 96) { // _
    return cAsciiCode === 95;
  }
  if(cAsciiCode < 123) { // a-z
    return cAsciiCode > 96;
  }
